...
type View = "main" | "match" | "matchHistory" | "settings" | "presets" | "botItems" | "commands" | "weaponPresets";

const VIEWS: View[] = ["main", "match", "matchHistory", "settings", "presets", "botItems", "commands", "weaponPresets"];
...
export default function App() {
  const { error, clearError, ready, config, reportError, exportDiagnostics } = useStore();
  const t = useT();
